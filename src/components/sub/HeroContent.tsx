      ...
      <motion.div variants={itemVariants} className="space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative bg-card/40 backdrop-blur-sm border border-primary/20 rounded-2xl p-6 shadow-2xl">
            <h2 title={profile.title} className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary via-blue-500 to-primary bg-clip-text text-transparent mb-3">
              {profile.title}
            </h2>
        ...
        <motion.div
          ...
          className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed space-y-2"
        >
